    ...
    $.extend(Plugin.prototype, {
                        ...
                        $.ajax({
                            ...
                            success : function( response ) {
                                ...
                                if (popupOptions.countries_prefixes.indexOf(country) < 0){
                                    // setting cookies
                                    document.cookie = "gdprPluginCountry=" + country;
                                    document.cookie = "gdprPlugin=false";
                                }else{
        ...
        firstForm: function (ajax, buttonCount, license) {
            ...
            $(function () {
                ...
                if (ajax) {
                    ...
                    $('body').append(('<div class="loader" style="position: absolute; top: 50%; left: 50%; z-index: 100; transform: translate(-50%, -50%);"></div>'));
        ...
        onAcceptModal: function () {
            ...
            $('.ct-ultimate-gdpr-cookie-modal-btn.save').on('click', function (e) {
                ...
                document.cookie = 'gdprPluginGroup=' + groupSelected;
                // setting gdpr cookie to true
                document.cookie = 'gdprPlugin=true';
        ...
        onAcceptPopup: function () {
            ...
            $('#ct-ultimate-gdpr-cookie-accept').on('click', function () {
                ...
                document.cookie = 'gdprPluginGroup=' + groupSelected;
                document.cookie = 'gdprPlugin=true';
                document.cookie = 'gdprPluginCountry=' + self.countryGlobal;
                $('#ct-ultimate-gdpr-cookie-popup').hide();
            });
        },
        ...
        popUpBox: function () {
            ...
            // container
            if (popupOptionStyle.position === 'top-panel') {
                popup.append('<div class="ct-container ct-ultimate-gdpr-cookie-popup-topPanel"> <div id="ct-ultimate-gdpr-cookie-content">' + popupOptions.popup_text + '</div></div>');
            } else if (popupOptionStyle.position === 'bottom-panel') {
                popup.append('<div class="ct-container ct-ultimate-gdpr-cookie-popup-bottomPanel"><div id="ct-ultimate-gdpr-cookie-content">' + popupOptions.popup_text + '</div></div>');
            } else {
                popup.append('<div id="ct-ultimate-gdpr-cookie-content">' + popupOptions.popup_text + '</div>');
