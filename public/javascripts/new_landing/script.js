...
function showMainImages() {
    var i;
    var images = document.getElementsByClassName("main_image");
    ...
    if(images != undefined && images.length > 0){
	    ...
	    if (mainImageIndex > images.length) {mainImageIndex = 1} 

	    images[mainImageIndex-1].style.display = "block"; 

	    setTimeout(showMainImages, 3000);
	}
}

function showKYCImages() {
    var i;
    var images = document.getElementsByClassName("kyc_image");
    ...
    if(images != undefined && images.length > 0){
	    ...
	    if (kycImageIndex > images.length) {kycImageIndex = 1} 

	    images[kycImageIndex-1].style.display = "block"; 

	    setTimeout(showKYCImages, 3000);
